...
//create class
class RecentlyTicketsOfAdmin{
  //create recently tickets of api
  static Future<List<TicktingModel>?> recentlyTicketsOfAdminFunction() async {
    //create variable
    ...
    try {
      //create variables
      final uri = Uri.parse("http://10.183.99.138:5000/count/recentlyRoleBasedTickets/admin");
