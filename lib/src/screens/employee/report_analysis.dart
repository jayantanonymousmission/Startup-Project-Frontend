...
class ReportAnalysisOfEmployee extends StatefulWidget {
  const ReportAnalysisOfEmployee({super.key});
  @override
  State<ReportAnalysisOfEmployee> createState() =>
      _ReportAnalysisOfEmployeeState();
}

class _ReportAnalysisOfEmployeeState
    extends State<ReportAnalysisOfEmployee> {
  //create some list
