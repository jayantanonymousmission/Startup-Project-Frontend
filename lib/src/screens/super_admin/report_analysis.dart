...
class ReportAnalysisOfSuperAdmin extends StatefulWidget {
  ...
  @override
  State<ReportAnalysisOfSuperAdmin> createState() =>
      _ReportAnalysisOfSuperAdminState();
}

class _ReportAnalysisOfSuperAdminState
    extends State<ReportAnalysisOfSuperAdmin> {
  //create some list
