...
class AdminInSuperAdmin extends StatefulWidget {
  const AdminInSuperAdmin({super.key});
  @override
  State<AdminInSuperAdmin> createState() => _AdminInSuperAdminState();
}

class _AdminInSuperAdminState extends State<AdminInSuperAdmin> {
  @override
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: LabelText(text: "Admin Data Panel"),
            ),
            Wrap(
              children: [
                CustomCard(
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(20, 40, 0, 0),
              child: LabelText(text: "Admin Data"),
            ),
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(20, 40, 0, 0),
              child: LabelText(text: "Admin Tickets"),
            ),
